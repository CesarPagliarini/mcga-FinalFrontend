...
import { addNuevoClienteAction } from '../../../Store/actions/clientsActions';
...
const NuevoCliente = ({ history }) => {
  ...
  // Llama el action.
  const addNuevoCliente = (client) => dispatch(addNuevoClienteAction(client));
